...
bool PaymentHandler::purchaseItem(std::string _itemid)
{
	try
	{
...
bool PaymentHandler::findPurchaseByName(std::string _username)
{
...
bool PaymentHandler::verifypaymentdetails(std::string username, std::string creditcardno, std::string cvv)
{
